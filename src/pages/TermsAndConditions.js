    ...
    <>
      ...
      <div className="dashboard_page terms_page">
        <div className="container-fluid">
          ...
          <div className="terms_content crownbet_content">
            <h2 className="crownbet_heading">1. Acceptance of Terms</h2>
            ...
            <h2 className="crownbet_heading">2. Eligibility</h2>
            ...
            <h2 className="crownbet_heading">3. Account and Registration</h2>
            ...
            <h2 className="crownbet_heading">4. Betting and Gaming Rules</h2>
            ...
            <h2 className="crownbet_heading">5. Deposits and Withdrawals</h2>
            ...
            <h2 className="crownbet_heading">6. Responsible Gaming</h2>
            ...
            <h2 className="crownbet_heading">7. Prohibited Use</h2>
            ...
            <h2 className="crownbet_heading">8. Limitation of Liability</h2>
            ...
            <h2 className="crownbet_heading">9. Changes to Terms</h2>
            ...
            <h2 className="crownbet_heading">10. Contact</h2>

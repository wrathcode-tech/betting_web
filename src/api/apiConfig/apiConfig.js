...
export const ApiConfig = {
  ...
  allWalletsPortfolio: "all-wallets-portfolio",
  ...
  securityMobileChangeInitiate: "mobile/change/initiate",
  securityMobileChangeComplete: "mobile/change/complete",
